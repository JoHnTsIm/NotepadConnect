...
class App(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.file_selector = Listbox(self.frame, bg="#333", fg="white", font="Verdana",
                                     selectforeground="black", selectbackground="#CCCC00", activestyle='none',
                                     selectmode=SINGLE)
        ...
        self.filemenu2.add_command(label="Log Out", command=logout)
    ...
    def load_user_files(self):
        current_user_folder = Locate().locate_user_folder()
    ...
    def save_current_as(self, event):
        ...
        save_location = path_to_save_as.replace("<_io.TextIOWrapper name='", "")\
            .replace("' mode='w' encoding='cp1253'>", "")
    ...
    # if the file hasn't any changes or gets saved the title returns to title+filename without the (*)
